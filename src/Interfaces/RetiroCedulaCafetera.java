 ...
 * @author Jhoan
 */
public class RetiroCedulaCafetera extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Retiro Cedula Cafetera");
        PanelPrincipal.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 150, -1));

        getContentPane().add(PanelPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 500, 500));
        ...
        try {
            ...
            if (clave.equals(this.txtClave.getText()) && DineroConsignarValidar >= Retirar) {
                try {
                    ...
                    ClaseFactura factura = new ClaseFactura(this.txtRetirar.getText(), "Retiro Cedula Cafetera", "" + this.log.Doc);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RetiroCedulaCafetera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RetiroCedulaCafetera().setVisible(true);
            }
        });
    }
