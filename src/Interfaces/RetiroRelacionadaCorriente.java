 ...
 * @author Jhoan
 */
public class RetiroRelacionadaCorriente extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RetiroRelacionadaCorriente
     */
    public RetiroRelacionadaCorriente() {
        initComponents();
        this.InitComponents();
    }
    ...
    private void initComponents() {
        ...
        MenuUSER3 = new javax.swing.JPanel();
        MenuUsuario3 = new javax.swing.JLabel();
        ...
        PanelPrincipal3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        PanelPrincipal3.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                PanelPrincipal3MouseDragged(evt);
            }
        });
        PanelPrincipal3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                PanelPrincipal3MousePressed(evt);
            }
        });
        PanelPrincipal3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        MenuUSER3.setBackground(new java.awt.Color(255, 255, 255));
        MenuUSER3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        MenuUsuario3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/Iconos/usuario (1).png"))); // NOI18N
        MenuUsuario3.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        MenuUsuario3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                MenuUsuario3MouseClicked(evt);
            }
        });
        MenuUSER3.add(MenuUsuario3, new org.netbeans.lib.awtextra.AbsoluteConstraints(26, 0, -1, -1));
        ...
        MenuUSER3.add(Atras4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 20, 20));

        PanelPrincipal3.add(MenuUSER3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 120, 20));
        ...
        PanelPrincipal3.add(Menuborde, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 180, 80));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/Iconos/icono7.png"))); // NOI18N
        PanelPrincipal3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, 180, 190));
        ...
        PanelPrincipal3.add(Minimizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 0, 20, 20));
        ...
        PanelPrincipal3.add(MoverBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 0, -1, -1));
        ...
        PanelPrincipal3.add(ClavePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 270, 180, 120));
        ...
        PanelPrincipal3.add(Salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 0, 20, 20));
        ...
        PanelPrincipal3.add(DineroPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 140, -1));
        ...
        PanelPrincipal3.add(RetirarPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 270, 170, 120));

        ClaveINCORRECTA.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        ClaveINCORRECTA.setText("La clave no es correcta");
        PanelPrincipal3.add(ClaveINCORRECTA, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 450, 140, -1));
        ...
        PanelPrincipal3.add(DineroInsuficiente, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 430, 250, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 3, 12)); // NOI18N
        jLabel3.setText("Retiro Cuenta Relacionada Corriente");
        PanelPrincipal3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 220, -1));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(PanelPrincipal3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(PanelPrincipal3, javax.swing.GroupLayout.PREFERRED_SIZE, 500, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
    ...
    private void MenuUsuario3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MenuUsuario3MouseClicked
        if (this.Menuborde.isVisible() == true) {
            this.Menuborde.setVisible(false);
        } else {
            this.Menuborde.setVisible(true);
        }
    }//GEN-LAST:event_MenuUsuario3MouseClicked
        ...
        try {
            ...
            if (clave.equals(this.txtClave.getText()) && DineroConsignarValidar >= Retirar) {
                try {
                    ...
                    ClaseFactura factura = new ClaseFactura(this.txtRetirar.getText(), "Retiro Relacionada Corriente", "" + this.log.Doc);
    ...
    private void PanelPrincipal3MouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PanelPrincipal3MouseDragged
        this.setLocation(this.getLocation().x + evt.getX() - x, this.getLocation().y + evt.getY() - y);
    }//GEN-LAST:event_PanelPrincipal3MouseDragged

    private void PanelPrincipal3MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PanelPrincipal3MousePressed
        x = evt.getX();
        y = evt.getY();
    }//GEN-LAST:event_PanelPrincipal3MousePressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RetiroRelacionadaCorriente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RetiroRelacionadaCorriente().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel MenuUSER3;
    private javax.swing.JLabel MenuUsuario3;
