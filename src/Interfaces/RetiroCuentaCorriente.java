 ...
 * @author Jhoan
 */
public class RetiroCuentaCorriente extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RetiroCuentaCorriente
     */
    public RetiroCuentaCorriente() {
        initComponents();
        this.InitComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/Iconos/icono5.png"))); // NOI18N
        ...
        jLabel3.setText("Retiro Cuenta Corriente");
        PanelPrincipal3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 150, -1));

        getContentPane().add(PanelPrincipal3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 500, 500));
        ...
        try {
            ...
            if (clave.equals(this.txtClave.getText()) && DineroConsignarValidar >= Retirar) {
                try {
                    ...
                    ClaseFactura factura = new ClaseFactura(this.txtRetirar.getText(), "Retiro Cuenta Corriente", "" + this.log.Doc);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RetiroCuentaCorriente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RetiroCuentaCorriente().setVisible(true);
            }
        });
    }
