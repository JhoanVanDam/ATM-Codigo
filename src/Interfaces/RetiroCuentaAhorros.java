 ...
 * @author Jhoan
 */
public class RetiroCuentaAhorros extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/Iconos/icono1.png"))); // NOI18N
        ...
        jLabel3.setText("Retiro Cuenta De Ahorros");
        ...
        try {
            ...
            if (clave.equals(this.txtClave.getText()) && DineroConsignarValidar >= Retirar) {
                try {
                    ...
                    ClaseFactura factura = new ClaseFactura(this.txtRetirar.getText(), "Retiro Cuenta Ahorros", ""+this.log.Doc);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RetiroCuentaAhorros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RetiroCuentaAhorros().setVisible(true);
            }
        });
    }
